  ...
  try {
    ...
    const result = await Promise.race([
      generateMockData(count, {
        generateUsersFlag: true,
        // Explicitly include collections to ensure they're generated in the right order
        collectionsToGenerate: [
          ...
          'reports',
          'requests',
          'projects', // Make sure projects are generated after financing
          'posts'
        ]
      }),
      timeoutPromise
